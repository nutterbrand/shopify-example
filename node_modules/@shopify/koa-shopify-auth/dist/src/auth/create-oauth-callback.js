...
function createOAuthCallback(config) {
    return function oAuthCallback(ctx) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var query, cookies, code, hmac, shop, nonce, apiKey, secret, afterAuth, accessTokenQuery, accessTokenResponse, accessTokenData, accessToken, associatedUserScope, associatedUser;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        accessToken = accessTokenData.access_token, associatedUserScope = accessTokenData.associated_user_scope, associatedUser = accessTokenData.associated_user;
                        if (ctx.session) {
