...
.Polaris-Banner--withinContentContainer_1uwmg.Polaris-Banner--keyFocused_1aqee::after{ box-shadow:0 0 0 0.2rem var(--p-focused, #5c6ac4); }
...
.Polaris-Banner--withinContentContainer_1uwmg.Polaris-Banner--statusSuccess_pc5rl.Polaris-Banner--keyFocused_1aqee::after{ box-shadow:0 0 0 0.2rem var(--p-focused, #5c6ac4); }
...
.Polaris-Banner--withinContentContainer_1uwmg.Polaris-Banner--statusInfo_knr66.Polaris-Banner--keyFocused_1aqee::after{ box-shadow:0 0 0 0.2rem var(--p-focused, #5c6ac4); }
...
.Polaris-Banner--withinContentContainer_1uwmg.Polaris-Banner--statusWarning_1x66d.Polaris-Banner--keyFocused_1aqee::after{ box-shadow:0 0 0 0.2rem var(--p-focused, #5c6ac4); }
...
.Polaris-Banner--withinContentContainer_1uwmg.Polaris-Banner--statusCritical_1iy3d.Polaris-Banner--keyFocused_1aqee::after{ box-shadow:0 0 0 0.2rem var(--p-focused, #5c6ac4); }
...
.Polaris-Banner--withinPage_kguwn.Polaris-Banner--keyFocused_1aqee::after{ box-shadow:0 0 0 0.2rem var(--p-focused, #5c6ac4); }
...
.Polaris-Banner--withinPage_kguwn.Polaris-Banner--statusSuccess_pc5rl.Polaris-Banner--keyFocused_1aqee::after{ box-shadow:0 0 0 0.2rem var(--p-focused, #5c6ac4); }
...
.Polaris-Banner--withinPage_kguwn.Polaris-Banner--statusInfo_knr66.Polaris-Banner--keyFocused_1aqee::after{ box-shadow:0 0 0 0.2rem var(--p-focused, #5c6ac4); }
...
.Polaris-Banner--withinPage_kguwn.Polaris-Banner--statusWarning_1x66d.Polaris-Banner--keyFocused_1aqee::after{ box-shadow:0 0 0 0.2rem var(--p-focused, #5c6ac4); }
...
.Polaris-Banner--withinPage_kguwn.Polaris-Banner--statusCritical_1iy3d.Polaris-Banner--keyFocused_1aqee::after{ box-shadow:0 0 0 0.2rem var(--p-focused, #5c6ac4); }
...
.Polaris-Banner__Button_r99lw.Polaris-Banner--newDesignLanguage_1rik8:focus::after{ box-shadow:0 0 0 0.2rem var(--p-focused, #5c6ac4); }
...
.Polaris-Banner__Button_r99lw:focus::after{ box-shadow:0 0 0 0.2rem var(--p-focused, #5c6ac4); }
