...
.Polaris-Tabs__Tab_375k2:focus:not(:active) .Polaris-Tabs__Title_2qj8j::after{ box-shadow:0 0 0 0.2rem var(--p-focused, #5c6ac4); }
...
.Polaris-Tabs__Item_yiyol.Polaris-Tabs--newDesignLanguage_1rik8:focus:not(:active)::after{ box-shadow:0 0 0 0.2rem var(--p-focused, #5c6ac4); }
...
.Polaris-Tabs--newDesignLanguage_1rik8 .Polaris-Tabs__Tab_375k2:active .Polaris-Tabs__Title_2qj8j::before{ background:var(--p-action-primary-pressed); }
...
.Polaris-Tabs--newDesignLanguage_1rik8 .Polaris-Tabs__Tab--selected_11sap:focus .Polaris-Tabs__Title_2qj8j::before{ background:var(--p-action-primary); }
...
@media (-ms-high-contrast: active){ .Polaris-Tabs--newDesignLanguage_1rik8 .Polaris-Tabs__Tab--selected_11sap .Polaris-Tabs__Title_2qj8j{ outline:0.3rem solid windowText; }
  .Polaris-Tabs--newDesignLanguage_1rik8 .Polaris-Tabs__Tab--selected_11sap .Polaris-Tabs__Title_2qj8j::before{ display:none; } }
